...
# Mapping items aux facettes
item_to_facette = {
    # Nevrosisme
    1: 'N1', 31: 'N1', 61: 'N1', 91: 'N1', 121: 'N1', 151: 'N1', 181: 'N1', 211: 'N1',  # N1: Anxiete
    6: 'N2', 36: 'N2', 66: 'N2', 96: 'N2', 126: 'N2', 156: 'N2', 186: 'N2', 216: 'N2',  # N2: Hostilite colerique
    11: 'N3', 41: 'N3', 71: 'N3', 101: 'N3', 131: 'N3', 161: 'N3', 191: 'N3', 221: 'N3',  # N3: Depression
    16: 'N4', 46: 'N4', 76: 'N4', 106: 'N4', 136: 'N4', 166: 'N4', 196: 'N4', 226: 'N4',  # N4: Timidite
    21: 'N5', 51: 'N5', 81: 'N5', 111: 'N5', 141: 'N5', 171: 'N5', 201: 'N5', 231: 'N5',  # N5: Impulsivite
    26: 'N6', 56: 'N6', 86: 'N6', 116: 'N6', 146: 'N6', 176: 'N6', 206: 'N6', 236: 'N6',  # N6: Vulnerabilite
    # Extraversion
    2: 'E1', 32: 'E1', 62: 'E1', 92: 'E1', 122: 'E1', 152: 'E1', 182: 'E1', 212: 'E1',  # E1: Chaleur
    7: 'E2', 37: 'E2', 67: 'E2', 97: 'E2', 127: 'E2', 157: 'E2', 187: 'E2', 217: 'E2',  # E2: Gregarite
    12: 'E3', 42: 'E3', 72: 'E3', 102: 'E3', 132: 'E3', 162: 'E3', 192: 'E3', 222: 'E3',  # E3: Affirmation de soi
    17: 'E4', 47: 'E4', 77: 'E4', 107: 'E4', 137: 'E4', 167: 'E4', 197: 'E4', 227: 'E4',  # E4: Activite
    22: 'E5', 52: 'E5', 82: 'E5', 112: 'E5', 142: 'E5', 172: 'E5', 202: 'E5', 232: 'E5',  # E5: Recherche d'excitation
    27: 'E6', 57: 'E6', 87: 'E6', 117: 'E6', 147: 'E6', 177: 'E6', 207: 'E6', 237: 'E6',  # E6: Emotions positives
    # Ouverture
    3: 'O1', 33: 'O1', 63: 'O1', 93: 'O1', 123: 'O1', 153: 'O1', 183: 'O1', 213: 'O1',  # O1: Imagination
    8: 'O2', 38: 'O2', 68: 'O2', 98: 'O2', 128: 'O2', 158: 'O2', 188: 'O2', 218: 'O2',  # O2: Esthetique
    13: 'O3', 43: 'O3', 73: 'O3', 103: 'O3', 133: 'O3', 163: 'O3', 193: 'O3', 223: 'O3',  # O3: Sentiments
    18: 'O4', 48: 'O4', 78: 'O4', 108: 'O4', 138: 'O4', 168: 'O4', 198: 'O4', 228: 'O4',  # O4: Actions
    23: 'O5', 53: 'O5', 83: 'O5', 113: 'O5', 143: 'O5', 173: 'O5', 203: 'O5', 233: 'O5',  # O5: Idees
    28: 'O6', 58: 'O6', 88: 'O6', 118: 'O6', 148: 'O6', 178: 'O6', 208: 'O6', 238: 'O6',  # O6: Valeurs
    # Agreeabilite
    4: 'A1', 34: 'A1', 64: 'A1', 94: 'A1', 124: 'A1', 154: 'A1', 184: 'A1', 214: 'A1',  # A1: Confiance
    9: 'A2', 39: 'A2', 69: 'A2', 99: 'A2', 129: 'A2', 159: 'A2', 189: 'A2', 219: 'A2',  # A2: Franchise
    14: 'A3', 44: 'A3', 74: 'A3', 104: 'A3', 134: 'A3', 164: 'A3', 194: 'A3', 224: 'A3',  # A3: Altruisme
    19: 'A4', 49: 'A4', 79: 'A4', 109: 'A4', 139: 'A4', 169: 'A4', 199: 'A4', 229: 'A4',  # A4: Compliance
    24: 'A5', 54: 'A5', 84: 'A5', 114: 'A5', 144: 'A5', 174: 'A5', 204: 'A5', 234: 'A5',  # A5: Modestie
    29: 'A6', 59: 'A6', 89: 'A6', 119: 'A6', 149: 'A6', 179: 'A6', 209: 'A6', 239: 'A6',  # A6: Tendresse
    # Conscience
    5: 'C1', 35: 'C1', 65: 'C1', 95: 'C1', 125: 'C1', 155: 'C1', 185: 'C1', 215: 'C1',  # C1: Competence
    10: 'C2', 40: 'C2', 70: 'C2', 100: 'C2', 130: 'C2', 160: 'C2', 190: 'C2', 220: 'C2',  # C2: Ordre
    15: 'C3', 45: 'C3', 75: 'C3', 105: 'C3', 135: 'C3', 165: 'C3', 195: 'C3', 225: 'C3',  # C3: Sens du devoir
    20: 'C4', 50: 'C4', 80: 'C4', 110: 'C4', 140: 'C4', 170: 'C4', 200: 'C4', 230: 'C4',  # C4: Effort pour reussir
    25: 'C5', 55: 'C5', 85: 'C5', 115: 'C5', 145: 'C5', 175: 'C5', 205: 'C5', 235: 'C5',  # C5: Autodiscipline
    30: 'C6', 60: 'C6', 90: 'C6', 120: 'C6', 150: 'C6', 180: 'C6', 210: 'C6', 240: 'C6'   # C6: Deliberation
}

# Mapping facettes aux domaines
facettes_to_domain = {
...
# Noms des facettes pour l'affichage
facette_labels = {
    'N1': 'N1 - Anxiete',
    'N2': 'N2 - Hostilite colerique',
    'N3': 'N3 - Depression',
    'N4': 'N4 - Timidite',
    'N5': 'N5 - Impulsivite',
    'N6': 'N6 - Vulnerabilite',
...
# Fonction pour pre-traiter l'image
def preprocess_image(image):
    ...
    if docCnt is None:
        raise ValueError("Contour du document non detecte.")
...
# Fonction pour detecter les bulles
def detect_bubbles(thresh, min_size=20, ar_min=0.85, ar_max=1.15):
    ...
    for c in cnts:
        ...
        ar = w / float(h)
        if w >= min_size and h >= min_size and ar >= ar_min and ar <= ar_max:
            questionCnts.append(c)

    if len(questionCnts) != 150:
        raise ValueError(f"Nombre de bulles incorrect (detecte {len(questionCnts)}, attendu 150).")

    questionCnts = contours.sort_contours(questionCnts, method="top-to-bottom")[0]

    return questionCnts

# Fonction pour evaluer les reponses
def evaluate_responses(questionCnts, thresh, page_num, min_fill=5, weak_fill=30, ambiguity_diff=15):
    ...
    for q in range(30):
        ...
        if max_fill < weak_fill:
            warnings.append(f"Item {item_id}, Page {page_num}: Detection faible - Bulle peu remplie ({max_fill:.2f}%).")
        sorted_fills = sorted(fills, reverse=True)
        if len(sorted_fills) > 1 and (sorted_fills[0] - sorted_fills[1]) < ambiguity_diff:
            warnings.append(f"Item {item_id}, Page {page_num}: Ambiguite - Multiples cercles similaires.")
        if max_fill < min_fill:
            warnings.append(f"Item {item_id}, Page {page_num}: Item non repondu.")
...
st.title("NEO PI-R OMR Scanner – Outil de Correction Automatique Professionnelle")

st.write("""
Cette application automatise la detection et le scoring des feuilles de reponses NEO PI-R via OMR.
Note : Cet outil est pour usage educatif ou personnel uniquement. Pour un usage clinique, utilisez les outils officiels de Pearson Clinical / ECPA.
Pour une detection optimale, scannez a 300 DPI, assurez un bon contraste, evitez les ombres.
Note : Seul JPG/PNG supportes (PDF non gere dans cette version basique ; convertissez vos PDF en images).
""")

debug = st.checkbox("Mode debug (affiche logs detailles)")

# Sliders pour calibration
min_bubble_size = st.slider("Taille minimale des bulles (pixels)", 10, 50, 20)
ar_min = st.slider("Ratio aspect min", 0.5, 1.0, 0.85, step=0.05)
ar_max = st.slider("Ratio aspect max", 1.0, 1.5, 1.15, step=0.05)
...
if uploaded_files and len(uploaded_files) <= 8:
    page_assign = {}
    available_pages = list(range(1,9))
    used_pages = []
    for i, file in enumerate(uploaded_files):
        page_num = st.selectbox(f"Assigner la page pour {file.name}", [p for p in available_pages if p not in used_pages], key=f"select_{i}")
        used_pages.append(page_num)
        page_assign[page_num] = file

    if len(page_assign) == len(uploaded_files) and st.button("Traiter les Pages et Calculer Scores"):
        all_responses = {}
        all_warnings = []
        processed_images = {}
        original_images = {}
        ...
        for page_num in sorted(page_assign):
            try:
                ...
                original_images[page_num] = original_image
                paper, thresh = preprocess_image(original_image)
                ...
                # Marquer les bulles en vert sur paper
                for q in range(30):
                    cnts_group = contours.sort_contours(questionCnts[q*5:(q+1)*5])[0]
                    option_idx = responses[q + 1 + 30 * (page_num - 1)]
                    cv2.drawContours(paper, [cnts_group[option_idx]], -1, (0, 255, 0), 3)

                processed_images[page_num] = paper

                page_warning_count = len(warnings)
                page_confidence = 100 * (1 - page_warning_count / 30)
                page_confidences.append(page_confidence)
                if debug:
                    st.write(f"Page {page_num} - Logs : {page_warning_count} avertissements, confiance {page_confidence:.2f}%")

            except Exception as e:
                st.error(f"Erreur lors du traitement de la page {page_num}: {str(e)}")
                all_warnings.append(f"Page {page_num}: Erreur de traitement - {str(e)}")

        if all_responses:
            facette_scores, domain_scores = calculate_scores(all_responses)

            global_confidence = sum(page_confidences) / len(page_confidences) if page_confidences else 0
            if global_confidence < 95:
                st.warning("Confiance globale faible (<95%) : Verifiez manuellement les detections.")

            st.subheader("Images traitees")
            for page_num in sorted(page_assign):
                st.write(f"Page {page_num} - Image originale")
                st.image(original_images[page_num], use_column_width=True)
                st.write(f"Page {page_num} - Image traitee (bulles detectees en vert)")
                st.image(processed_images[page_num], channels="BGR", use_column_width=True)

            st.subheader("Tableau des scores par facette")
            score_data = []
            ...
            domain_data = []
            for dom in sorted(domain_labels.keys()):
                domain_data.append({
                    "Domaine": domain_labels[dom],
                    "Score": domain_scores[dom]
                })
            st.dataframe(domain_data)

            st.subheader("Avertissements et Validite")
            if all_warnings:
                for w in all_warnings:
                    st.warning(w)
            else:
                st.success("Aucun avertissement - Detection parfaite.")

            if len(all_warnings) / len(all_responses) > 0.05:
                st.info("Plus de 5% d'avertissements : Suggest verification manuelle.")
            ...
            output.write("\n")
            domain_writer = csv.DictWriter(output, fieldnames=["Domaine", "Score"])
            domain_writer.writeheader()
            domain_writer.writerows(domain_data)

            st.download_button(
                label="Telecharger CSV des scores",
    ...
    if uploaded_files:
        st.warning("Maximum 8 pages. Veuillez uploader jusqu'a 8 fichiers.")
